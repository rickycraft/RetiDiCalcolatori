...
{
	union {
		char *visualizza_1_arg;
		Licenza aggiorna_1_arg;
	} argument;
	char *result;
	...
	case VISUALIZZA:
		...
		_xdr_result = (xdrproc_t) xdr_Prenotazioni;
		local = (char *(*)(char *, struct svc_req *)) visualizza_1_svc;
		break;

	case AGGIORNA:
		_xdr_argument = (xdrproc_t) xdr_Licenza;
		_xdr_result = (xdrproc_t) xdr_int;
		local = (char *(*)(char *, struct svc_req *)) aggiorna_1_svc;
		break;
