...
#pragma region setup
  ...
  for (int i = 0; i < MAX_DATI; i++)
  {
    ...
    strcpy(dati[i].dir_img, "L");
  }

  strcpy(dati[0].targa, "EF123EF");
  strcpy(dati[0].tipo, "camper");
  strcpy(dati[0].patente, "12345");
  strcpy(dati[0].dir_img, "./EF123EF_img");

  strcpy(dati[1].targa, "ZZ123EF");
  strcpy(dati[1].tipo, "auto");
  strcpy(dati[1].patente, "12345");
  strcpy(dati[1].dir_img, "./ZZ123EF_img");

  strcpy(dati[2].targa, "XX123EF");
  strcpy(dati[2].tipo, "auto");
  strcpy(dati[2].patente, "12345");
  strcpy(dati[2].dir_img, "./XX123EF_img");
